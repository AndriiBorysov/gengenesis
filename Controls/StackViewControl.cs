...
namespace GenGenesis.Controls
{
    public partial class StackViewControl : UserControl
    {
        ...
        private ToolStripButton signStackButton;
        private ToolStripButton illnessStackButton;
        private ToolStripButton tcxStackButton;
        private ToolStripButton genesStackButton;
        private ToolStripButton scriningStackButton;
        private ToolStripButton biochemStackButton;
        ...
        public class CheckedChangedEventArgs : EventArgs
        {
            ...
            public CheckedChangedEventArgs(string currentPosition)
            {
                this.currentPosition = currentPosition;
            }
        }
        public event EventHandler<CheckedChangedEventArgs> CheckedChanget;
        #endregion
        ...
        private void stackButton_Click(object sender, EventArgs e)
        {
            foreach (ToolStripItem item in this.stackStrip.Items)
            {
                ...
                if ((item == sender) && (item is ToolStripButton))
                {
                    ...
                    EventHandler<CheckedChangedEventArgs> temp = CheckedChanget;
                    if (temp != null)
                        temp(this, new CheckedChangedEventArgs(item.Text));
                }

            }
        }
        #endregion
        private void InitializeImages() // Инициализирует иконки для каждого из элементов 
        {
            this.signStackButton.Image = mailBmp;
            this.illnessStackButton.Image = calendarBmp;
            this.tcxStackButton.Image = contactsBmp;
            this.genesStackButton.Image = tasksBmp;
            this.scriningStackButton.Image = tasksBmp;
            this.biochemStackButton.Image = tasksBmp;
        }
        private static void CreateBitmaps() // Создаёт все картинки
        {
        ...
        internal static Bitmap DeserializeFromBase64(string data) // Создаёт картинку из Base64
        {            
        ...
        internal class StackRenderer : ToolStripProfessionalRenderer
        {
            ...
            private static string titleBarGripEnc = @"Qk16AQAAAAAAADYAAAAoA" +
                "AAAIwAAAAMAAAABABgAAAAAAAAAAADEDgAAxA4AAAAAAAAAAAAAuGMy+/n" +
                "5+/n5uGMyuGMy+/n5+/n5uGMyuGMy+/n5+/n5uGMyuGMy+/n5+/n5uGMyu" +
                "GMy+/n5+/n5uGMyuGMy+/n5+/n5uGMyuGMy+/n5+/n5uGMyuGMy+/n5+/n5" +
                "uGMyuGMy+/n5+/n5ANj+RzIomHRh+/n5wm8/RzIomHRh+/n5wm8/RzIomHR" +
                "h+/n5wm8/RzIomHRh+/n5wm8/RzIomHRh+/n5wm8/RzIomHRh+/n5wm8/R" +
                "zIomHRh+/n5wm8/RzIomHRh+/n5wm8/RzIomHRh+/n5ANj+RzIoRzIozHtMz" +
                "HtMRzIoRzIozHtMzHtMRzIoRzIozHtMzHtMRzIoRzIozHtMzHtMRzIoRzIo" +
                "zHtMzHtMRzIoRzIozHtMzHtMRzIoRzIozHtMzHtMRzIoRzIozHtMzHtMRzIo" + 
                "RzIozHtMANj+";
            ...
            {
                titleBarGripBmp = StackViewControl.DeserializeFromBase64(titleBarGripEnc);
            }
            ...
            // Отрисовка бара (пимпочки)
            private void DrawTitleBar(Graphics g, Rectangle rect)
            {
                // Картинка для пимпочки
                Image titlebarGrip = titleBarGripBmp;
                
                // Заполняем пимпочку
                // Это создаёт эффект градиента
            ...
            // Отрисовка границы... походу наверное 
            ...
            protected override void OnRenderButtonBackground(ToolStripItemRenderEventArgs e)
            {
                ...
                // Затемнение границы последнего элемента
                if (nextItem == null)
                {
                    g.DrawLine(
                        SystemPens.ControlDarkDark,

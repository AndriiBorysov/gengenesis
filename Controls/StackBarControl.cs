...
{
    public partial class StackBarControl : UserControl
    {
        /// <summary>
        ...
        public class OutlookBarButtons : CollectionBase
        {
            ...
            protected StackBarControl parent;
            public StackBarControl Parent
            {
                get { return parent; }
            }

            internal OutlookBarButtons(StackBarControl parent)   : base()
            {
                this.parent = parent;
            }
        ...
        #region StackBarControl property definitions
        ...
        #endregion StackBarControl property definitions

        #region StackBarControl events
        ...
        #endregion StackBarControl events

        #region StackBarControl functions
        ...
        #endregion StackBarControl functions

        #region StackBarControl control event handlers
        ...
        #endregion StackBarControl control event handlers
    ...
    public class OutlookBarButton // : IComponent
    {
        ...
        {
            this.parent = new StackBarControl(); // set it to a dummy outlookbar control
            text = "";
        }

        public OutlookBarButton(StackBarControl parent)
        {
            this.parent = parent;
            text = "";
        }
        ...
        internal StackBarControl Parent
        {
            get { return parent; }
            set { parent = value; }
        }
        ...
        /// <summary>
        /// the outlook button will paint itself on its container (the StackBarControl)
        /// </summary>
